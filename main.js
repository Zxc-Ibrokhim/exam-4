...
// console.log(harflar[7] , harflar[1] , harflar[16] , harflar[13] , harflar[9] , harflar[6] , harflar[7] , harflar[11]);
...
//   let yosh = prompt("Enter your age");
//   if (yosh >= 18) {
//       alert("Siz balag'at yoshiga yetgansiz");
//   } else {
...
// console.log("Ваше имя наоборот: " + reversedName);
